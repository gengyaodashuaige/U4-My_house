      ...
      <TBODY>
        <c:forEach items="${pageInfo.list}" var="h">
          <TR>
            ...
            <TD class=house-type><LABEL class=ui-green><INPUT onclick="location.href='/page/editHouse?id=${h.id}'" value="修    改" type=button name=search></LABEL></TD>
